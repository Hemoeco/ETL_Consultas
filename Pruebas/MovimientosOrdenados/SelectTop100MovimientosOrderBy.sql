/* ----------------------------------------------------
-- Hemoeco Renta (2025)
-- Script: SelectTop100MovimientosOrderBy.sql
-- Vista para la consulta de documentos
-- lee los documentos de Score para importarlos a Comercial
-- Este ordenamiento no funciona, ETL solicita:
-- Select * from Movimientos
--
-- Este ordenamiento no se observa como se desea al final
------------------------------------------------------- */

CREATE OR ALTER VIEW [dbo].[MovimientosTop100] AS
...
SELECT TOP 100 PERCENT [cIdDocumento]
      ,[cCodigoProducto]
      ,[cUnidadesCapturadas]
      ,[cPrecioCapturado]
      ,[cImpuesto1]
